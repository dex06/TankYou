...
public class MediumTankA implements PlugInGraphic {
    ...
    public void draw(Player player, CanvasGUI canvas) {
        ...
        Image hull = ImageLoader.loadImage("/tanks2/colorA/hulls/Hull_01.png", MediumTankA.class);
        ImageView ivHull = new ImageView(hull);
        ivHull.setFitWidth(w);
        ivHull.setFitHeight(h);


        Image gun = ImageLoader.loadImage("/tanks2/colorA/guns/Gun_01.png", MediumTankA.class);
