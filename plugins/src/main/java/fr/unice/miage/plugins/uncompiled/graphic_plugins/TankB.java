...
public class TankB implements PlugInGraphic {
    ...
    public void draw(Player player, CanvasGUI canvas) {
        ...
        Image hull;
        try {
            hull = new Image(TankA.class.getClassLoader().getResourceAsStream("/tanks2/colorB/hulls/Hull_01.png"));
        } catch (Exception e) {
            hull = new Image("/tanks2/colorB/hulls/Hull_01.png");
        }
        ...
        Image gun;
        try {
            gun = new Image(TankA.class.getClassLoader().getResourceAsStream("/tanks2/colorB/guns/Gun_01.png"));
        } catch (Exception e) {
            gun = new Image("/tanks2/colorB/guns/Gun_01.png");
        }
        ...
        if(Timer.getChrono() % 2 == 0){
            try {
                track = new Image(TankA.class.getClassLoader().getResourceAsStream("/tanks2/colorB/tracks/Track_1_A.png"));
            } catch (Exception e){
                track = new Image("/tanks2/colorB/tracks/Track_1_A.png");
            }
        } else {
            try {
                track = new Image(TankA.class.getClassLoader().getResourceAsStream("/tanks2/colorB/tracks/Track_1_B.png"));
            } catch (Exception e){
                track = new Image("/tanks2/colorB/tracks/Track_1_B.png");
            }
        }
