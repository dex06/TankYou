...
public class LightTankB implements PlugInGraphic {
    ...
    public void draw(Player player, CanvasGUI canvas) {
        ...
        Image hull = ImageLoader.loadImage("/tanks2/colorB/hulls/Hull_02.png", LightTankB.class);
        ImageView ivHull = new ImageView(hull);
        ivHull.setFitWidth(w);
        ivHull.setFitHeight(h);


        Image gun = ImageLoader.loadImage("/tanks2/colorB/guns/Gun_02.png", LightTankB.class);
        ...
        if((int) Timer.getChrono() % 2 == 0 && player.isAlive()){
            track = ImageLoader.loadImage("/tanks2/colorB/tracks/Track_2_A.png", LightTankB.class);
        } else {
            track = ImageLoader.loadImage("/tanks2/colorB/tracks/Track_2_B.png", LightTankB.class);
        }
        ...
        if(!player.isAlive()){
            c.save();
            c.translate(x,y);
            Image skull = ImageLoader.loadImage("/other/skull.png", LightTankB.class);
