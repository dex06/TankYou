...
public class Rectangle implements PlugInGraphic {
    ...
    private fr.unice.miage.common.sprite.RectangleSprite playerSprite;
    ...
    public void init(Player player){
        this.player = player;
        this.playerSprite = new fr.unice.miage.common.sprite.RectangleSprite(player, width, height, color, true);
